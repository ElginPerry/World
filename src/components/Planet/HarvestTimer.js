...
function BuildTimer(props) {
  ...
  return (
    <div>
      <div style={{textAlign: "center", width:"5%", display: "inline-block", fontSize: width>450 ? "12px" : "10px"}}>    
          {buildingName}
      </div>
      <div style={{textAlign: "right", width:"95%", maxWidth:"200px", display: "inline-block", paddingLeft: "5px", fontSize: width>450 ? "14px" : "12px", border: "1px solid gold",paddingRight: "10px" }}>    
